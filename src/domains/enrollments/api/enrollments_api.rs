use crate::domains::enrollments::models::enrollment::EnrollmentNew;
...
pub async fn get_enrollment(
    ...
    match middleware(req).await {
        Ok(claims) => {
            ...
            match state.enrollments.repo.db_get_enrollment(id.into_inner().as_str()).await {
...
pub async fn create_enrollment(
    ...
    match middleware(req).await {
        Ok(claims) => {
            ...
            match state.enrollments.repo.db_create_enrollment(payload.into_inner()).await {
