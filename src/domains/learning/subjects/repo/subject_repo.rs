...
pub trait SubjectRepository {
    // READERS
    async fn db_get_subject(&self, id: &str) -> sqlx::Result<Option<Subject>, sqlx::Error>;
    ...
    // CREATOR
    async fn db_create_subject(&self, subject_new: &SubjectNew) -> sqlx::Result<Option<Subject>, sqlx::Error>;
